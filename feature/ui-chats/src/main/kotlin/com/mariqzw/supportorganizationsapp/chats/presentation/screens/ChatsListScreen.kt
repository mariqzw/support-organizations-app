...
fun ChatsListScreen() {
    ...
    val messages = remember {
        listOf(
            Message(
                "Борис Иванов",
                "Добрый день! Через 5 минут подойду ко входу. Постараюсь как можно скорее прибыть на место",
                "12:40"
            ),
            ...
            Message(
                "Константин Синицын",
                "Здравствуйте! Ожидаю вас у входа на станцию Бутырская.",
                "10:06"
            ),
            Message(
                "Алексей Синицын",
    ...
    Column {
        Text(
            text = "Данный экран в разработке, но вы можете ознакомиться с его будущим видом:",
